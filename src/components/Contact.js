  ...
  return (
    <div className='contact-wrapper' id='contact'>
      ...
      <div className='contact__link--icons'>
        <a
          href='https://www.linkedin.com/in/mallory-virginia-woods'
          target='_blank'
        ...
        <a
          href='https://www.instagram.com/mallmsy/'
          target='_blank'
          rel='noopener noreferrer'
          className='contact__item'
        >
        ...
        <a
          href='https://twitter.com/mallmsyyy'
          target='_blank'
          rel='noopener noreferrer'
          className='contact__item'
        >
        ...
        <a
          href='https://medium.com/@malvwoods'
          target='_blank'
          rel='noopener noreferrer'
          className='contact__item'
        >
          <img
            src='img/logos/medium.svg'
            alt='medium'
            className='contact__link--icon'
          ></img>
        </a>
